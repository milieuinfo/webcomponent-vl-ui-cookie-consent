...
## API
De [API](https://webcomponenten.omgeving.vlaanderen.be/doc/VlCookie-consent.html) bevat een overzicht van de ondersteunde attributen en een beschrijving van de beschikbare functies.
...
## Versionering
We gebruiken [Semantic Versioning](https://semver.org) en voorzien elke release van release notes, zie een overzicht van de [releases](https://github.com/milieuinfo/webcomponent-vl-ui-cookie-consent/releases).
...
## Credits
Zie de lijst van [ontwikkelaars](https://github.com/milieuinfo/webcomponent-vl-ui-cookie-consent/graphs/contributors) die meegewerkt hebben aan de webcomponent.
