import {VlElement, define} from '/node_modules/vl-ui-core/dist/vl-core.min.js'; import '/node_modules/vl-ui-checkbox/dist/vl-checkbox.min.js'; import '/node_modules/vl-ui-form-message/dist/vl-form-message.min.js'; export class VlCookieConsentOptIn extends (VlElement(HTMLElement)) {
  ...
  }_labelChangedCallback(e, t) {
    this._checkboxElement.setAttribute('label', t);
  }_descriptionChangedCallback(e, t) {
t?this._descriptionElement?this._descriptionElement.textContent=t:this._element.appendChild(this._getDescriptionTemplate(t)):this._descriptionElement.remove();
  }_checkedChangedCallback(e, t) {
    null!=t&&this._checkboxElement.setAttribute('checked', '');
  }_mandatoryChangedCallback(e, t) {
    null!=t&&(this._checkboxElement.setAttribute('checked', ''), this._checkboxElement.setAttribute('disabled', ''));
  }
